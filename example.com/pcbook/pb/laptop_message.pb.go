...
type Laptop struct {
	...
	Gpus     []*GPU     `protobuf:"bytes,6,rep,name=gpus,proto3" json:"gpus,omitempty"` // This field is a list of GPU messages
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x32, 0x16, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x63, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63,
	...
	0x68, 0x73, 0x68, 0x63, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d,
	...
	0x68, 0x63, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x47, 0x50, 0x55,
	...
	0x68, 0x63, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x74, 0x6f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x63, 0x6f, 0x6f, 0x6c,
	...
	0x64, 0x41, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0x17, 0x5a,
	0x15, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x63, 0x62,
...
var file_laptop_message_proto_goTypes = []any{
	(*Laptop)(nil),                // 0: techshcool.pcbook.Laptop
	(*CPU)(nil),                   // 1: techshcool.pcbook.CPU
	(*Memory)(nil),                // 2: techshcool.pcbook.Memory
	(*GPU)(nil),                   // 3: techshcool.pcbook.GPU
	(*Storage)(nil),               // 4: techshcool.pcbook.Storage
	(*Screen)(nil),                // 5: techshcool.pcbook.Screen
	(*Keyboard)(nil),              // 6: techshcool.pcbook.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: techshcool.pcbook.Laptop.cpu:type_name -> techshcool.pcbook.CPU
	2, // 1: techshcool.pcbook.Laptop.ram:type_name -> techshcool.pcbook.Memory
	3, // 2: techshcool.pcbook.Laptop.gpus:type_name -> techshcool.pcbook.GPU
	4, // 3: techshcool.pcbook.Laptop.storages:type_name -> techshcool.pcbook.Storage
	5, // 4: techshcool.pcbook.Laptop.screen:type_name -> techshcool.pcbook.Screen
	6, // 5: techshcool.pcbook.Laptop.keyboard:type_name -> techshcool.pcbook.Keyboard
	7, // 6: techshcool.pcbook.Laptop.updated_at:type_name -> google.protobuf.Timestamp
