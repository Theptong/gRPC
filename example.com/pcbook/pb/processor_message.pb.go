...
type GPU struct {
	...
	Memory *Memory `protobuf:"bytes,5,opt,name=memory,proto3" json:"memory,omitempty"` // ใช้ Memory จากไฟล์ memory_message.proto
}
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x68, 0x63, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x63, 0x6f, 0x6f,
	0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52,
	0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x17, 0x5a, 0x15, 0x65, 0x78, 0x61, 0x6d, 0x70,
	0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2f, 0x70, 0x62,
...
var file_processor_message_proto_goTypes = []any{
	(*CPU)(nil),    // 0: techshcool.pcbook.CPU
	(*GPU)(nil),    // 1: techshcool.pcbook.GPU
	(*Memory)(nil), // 2: techshcool.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: techshcool.pcbook.GPU.memory:type_name -> techshcool.pcbook.Memory
