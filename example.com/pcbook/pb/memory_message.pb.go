...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=techshcool.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x68, 0x63, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d,
	...
	0x12, 0x0c, 0x0a, 0x08, 0x54, 0x45, 0x52, 0x41, 0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x17,
	0x5a, 0x15, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x63,
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: techshcool.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: techshcool.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: techshcool.pcbook.Memory.unit:type_name -> techshcool.pcbook.Memory.Unit
