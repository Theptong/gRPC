...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x63, 0x6f, 0x6f, 0x6c,
...
var file_auth_service_proto_goTypes = []any{
	(*LoginRequest)(nil),  // 0: techshcool.pcbook.LoginRequest
	(*LoginResponse)(nil), // 1: techshcool.pcbook.LoginResponse
}
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: techshcool.pcbook.AuthService.Login:input_type -> techshcool.pcbook.LoginRequest
	1, // 1: techshcool.pcbook.AuthService.Login:output_type -> techshcool.pcbook.LoginResponse
