...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=techshcool.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x63,
	...
	0x22, 0x9f, 0x01, 0x0a, 0x07, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x39, 0x0a, 0x06,
	...
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68,
	0x63, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f,
	0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x22, 0x26, 0x0a, 0x06, 0x44, 0x72,
	0x69, 0x76, 0x65, 0x72, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x10, 0x00,
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: techshcool.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: techshcool.pcbook.Storage
	(*Memory)(nil),      // 2: techshcool.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: techshcool.pcbook.Storage.driver:type_name -> techshcool.pcbook.Storage.Driver
	2, // 1: techshcool.pcbook.Storage.memory:type_name -> techshcool.pcbook.Memory
