...
type Screen_Panal int32

const (
	Screen_UNKNOW Screen_Panal = 0
	Screen_IPS    Screen_Panal = 1
	Screen_OLED   Screen_Panal = 2
)

// Enum value maps for Screen_Panal.
var (
	Screen_Panal_name = map[int32]string{
		0: "UNKNOW",
		1: "IPS",
		2: "OLED",
	}
	Screen_Panal_value = map[string]int32{
		"UNKNOW": 0,
		"IPS":    1,
		"OLED":   2,
	}
...
func (x Screen_Panal) Enum() *Screen_Panal {
	p := new(Screen_Panal)
	*p = x
	return p
}

func (x Screen_Panal) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Screen_Panal) Descriptor() protoreflect.EnumDescriptor {
	return file_screen_message_proto_enumTypes[0].Descriptor()
}

func (Screen_Panal) Type() protoreflect.EnumType {
	return &file_screen_message_proto_enumTypes[0]
}

func (x Screen_Panal) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Screen_Panal.Descriptor instead.
func (Screen_Panal) EnumDescriptor() ([]byte, []int) {
...
type Screen struct {
	...
	Panal      Screen_Panal       `protobuf:"varint,3,opt,name=panal,proto3,enum=techshcool.pcbook.Screen_Panal" json:"panal,omitempty"`
...
func (x *Screen) GetPanal() Screen_Panal {
	if x != nil {
		return x.Panal
	}
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x63, 0x6f,
	...
	0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x05, 0x70, 0x61, 0x6e, 0x61, 0x6c,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x63,
	0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65,
	0x6e, 0x2e, 0x50, 0x61, 0x6e, 0x61, 0x6c, 0x52, 0x05, 0x70, 0x61, 0x6e, 0x61, 0x6c, 0x12, 0x1e,
	...
	0x6e, 0x61, 0x6c, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x10, 0x00, 0x12,
	0x07, 0x0a, 0x03, 0x49, 0x50, 0x53, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44,
	0x10, 0x02, 0x42, 0x17, 0x5a, 0x15, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panal)(0),         // 0: techshcool.pcbook.Screen.Panal
	(*Screen)(nil),            // 1: techshcool.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: techshcool.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: techshcool.pcbook.Screen.resolution:type_name -> techshcool.pcbook.Screen.Resolution
	0, // 1: techshcool.pcbook.Screen.panal:type_name -> techshcool.pcbook.Screen.Panal
