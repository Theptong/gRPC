...
const (
	LaptopService_CreateLaptop_FullMethodName = "/techshcool.pcbook.LaptopService/CreateLaptop"
	LaptopService_RateLaptop_FullMethodName   = "/techshcool.pcbook.LaptopService/RateLaptop"
	LaptopService_SearchLaptop_FullMethodName = "/techshcool.pcbook.LaptopService/SearchLaptop"
	LaptopService_UploadImage_FullMethodName  = "/techshcool.pcbook.LaptopService/UploadImage"
)
...
func (c *laptopServiceClient) SearchLaptop(ctx context.Context, in *SearchLaptopRequest, opts ...grpc.CallOption) (LaptopService_SearchLaptopClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[1], LaptopService_SearchLaptop_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *laptopServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (LaptopService_UploadImageClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[2], LaptopService_UploadImage_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
var LaptopService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "techshcool.pcbook.LaptopService",
